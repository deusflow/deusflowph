...
import { observeLazyImages, createStateMessage, initScrollReveals, escapeHTML, getOptimizedImageUrl } from "./ui.js?v=20260819-27";
...
async function renderWeddings() {
  ...
  try {
    ...
    albums.forEach((album) => {
      ...
      card.href = `album/?slug=${encodeURIComponent(album.slug)}`;
