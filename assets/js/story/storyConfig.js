...
export const rawBlueFireConfig = {
  ...
  flameIntensity: 0.5,   // Накал и свечение самого огня и ореола (0.2 - тусклый/мягкий, 8.8 - яркий накал, 15.0 - ослепительный)

  // 1b. Конусность и плотность основания:
  flameTaper: 3,       // Сужение к верху: чем выше (1.5 - 3.5), тем уже и острее верхушка
  ...
  offset: [0, -0.20, 0],   // Смещение относительно пустышки fog2 [X, Y, Z]
