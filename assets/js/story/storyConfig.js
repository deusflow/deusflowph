...
export const rawAltarMistConfig = {
  ...
  // 0.85 или 85% — плотный густой ковер тумана на полу и плите (по умолчанию)
  ...
  opacity: 0.85,          // Прозрачность ковра тумана на алтаре (0.0..1.0, либо 0..100%)
  carpetDensity: 1.25,    // Насыщенность и густота ковра (1.0 - стандарт, 1.5 - ультра-плотный)
  flowSpeed: 0.28,        // Скорость мягкого перекатывания дымки по плите и камням
  yOffset: 0.02,          // Микро-подъем (2 см) над плитами пола для устранения мерцания (z-fighting)

  // 2. Геометрия ковра и пара:
  carpetSpread: 1.20,     // Ширина покрытия ковра по плите алтаря (вокруг и позади чаши)
  steamHeight: 0.45,      // Мягкий невысокий подъем пара над чашей (фокус на плотном ковре)
  steamRadius: 0.45,      // Ширина дымки над чашей
