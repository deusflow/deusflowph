...
export const rawBlueFireConfig = {
  ...
  flameHeight: 1.0,      // Физическая высота пламени в единицах Three.js
  flameWidth: 0.85,      // Ширина пламени у основания
  flamePower: 0.6,       // Сила вертикальной тяги и длина выброса (0.2 - тихий огонёк, 1.5 - мощный столб)
  flameIntensity: 0.3,   // Накал и свечение самого огня и ореола (0.2 - тусклый/мягкий, 8.8 - яркий накал, 15.0 - ослепительный)

  // 1b. Конусность и плотность основания:
  flameTaper: 2.2,       // Сужение к верху: чем выше (1.5 - 3.5), тем уже и острее верхушка
  bottomSpread: 1.2,     // Ширина чаши у основания (0.5 - тонкая ножка, 1.3 - широкое устойчивое основание)
  bottomDensity: 1.8,    // Плотность и густота низа (0.5 - полупрозрачный, 2.0 - плотный насыщенный низ)
  ...
  offset: [0, -0.30, 0],   // Смещение относительно пустышки fog2 [X, Y, Z]

  // 3. Динамический источник света на скалах каньона (PointLight):
  lightIntensity: 10.5,  // Яркость мерцающего света на стенах каньона
