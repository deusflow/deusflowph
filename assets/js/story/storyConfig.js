...
export const rawAltarMistConfig = {
  ...
  opacity: 0.40,          // Общая прозрачность тумана (0.1 - тончайший флер, 0.4 - оптимум, 0.8 - плотный светящийся туман)
  puffDensity: 0.85,      // Плотность объемных клубов тумана

  // 2. Размеры зон маскировки:
  groundRadius: 2.20,     // Радиус стелющейся подушки у основания алтаря (в метрах)
  puffRadius: 1.35,       // Радиус объемных клубов тумана
  puffHeight: 0.55,       // Высота подъема клубов тумана над пустышками

  // 3. Скорость движения:
  flowSpeed: 0.35,        // Скорость мягкого перекатывания и клубящегося движения
  ...
  // 5. Атмосферная палитра тумана (тускло-синий эфирный свет, без черноты):
  groundColor: new THREE.Color(0x0a406c), // Мягкий полуночно-лазурный тон основания
  puffColor: new THREE.Color(0x10558a),   // Мягкий дымчатый сапфировый цвет клубов
  rimColor: new THREE.Color(0x2da8e8)     // Светящийся бирюзово-небесный отблеск синего огня
};
